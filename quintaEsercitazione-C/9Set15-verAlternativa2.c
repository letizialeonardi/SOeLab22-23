...
int main (int argc, char **argv)
{
   ...
   char token='v'; 			/* carattere che serve per sincronizzare i figli: anche in questo caso si usa un solo valore */
	...
	/* per i figli invece per cui il confronto non e' fallito andiamo a chiudere tutte le pipe rimaste aperte in modo che i figli possano uscire dal ciclo while */ 
	for(i=0;i<N;i++)
	{ 
